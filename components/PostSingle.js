...
const BlogSinglePost = ({ frontmatter, content, nextPrev, slug }) => {
  const post = nextPrev.filter((x) => x.slug != slug);

  return (
    <section className="section">
      <div className="container mx-auto">
        <div className="rounded-xl bg-light px-8 pt-14 pb-32 text-center md:px-14 md:pb-40 md:pt-20 lg:px-20">
        ...
        <div className="z-10 mx-auto -mt-20 w-4/5 rounded-md border border-light bg-white p-5 md:p-10 lg:p-16">
          {frontmatter.image && (
            <Image
          ...
          <div className="mt-10 hidden border-t border-border-default pt-10">
