...
const HeroSection = ({ banner }) => {
  const { title, bio, image, image_light } = banner;
  return (
    <>
      <section className="section banner pb-0">
        <div className="container">
          <div className="mb-16 flex flex-col items-center text-center md:flex-row md:text-left">
            <div className="mt-12 md:mt-0">
              <div className="mb-5 flex items-center justify-center font-primary md:justify-start">
                <svg
                  ...
                  height={38}
                  width={38}
                  className="hidden dark:invert sm:inline"
                >
                  <path
              ...
              <h1 className="order-last text-[1.5rem] font-semibold md:order-first md:text-h1 2xl:text-[2.4rem]">
                {bio}
              </h1>
            </div>

            <div className="order-first mx-auto block w-1/2 text-center md:order-last md:w-[50%] lg:w-4/5 xl:w-[55%] 2xl:w-4/5">
              <Image
