    ...
    >
      <section className="section mx-auto max-w-[1260px]">
        <div className="container mx-auto">
          <div className="mb-5 items-center font-primary sm:flex">
            <svg
              viewBox="0 0 38 38"
              fill="none"
            ...
            {markdownify(title, "h2", "section-title sm:ml-3 sm:mt-0 mt-3")}
          </div>
          <h3 className="relative mb-16 inline-block text-[1.5rem] font-semibold lg:text-[2rem] xl:text-[2.9rem]">
            <svg
              className="absolute left-full -mt-5 origin-left scale-[.60] dark:invert sm:scale-100"
              width="75"
              height="75"
              viewBox="0 0 75 75"
              fill="none"
