...
import { clamp, getMousePos, lerp, map } from "./image-utils";
const images_list = {
  a: "../../images/brands/brand-preview/ght.png",
  b: "../../images/brands/brand-preview/tf.png",
  b: "../../images/brands/brand-preview/sh.png",
};
const images = Object.entries(images_list);
